...
async function main() {
  console.log('=== CHECKING CORRECT DEALER URLS FOR 2022-2023 SOUL EX ===\n');

  // Correct Kia dealer URLs
  await checkDealer('Bessada Kia (Pickering)', 'https://www.bessadakia.com/en/used-inventory');
  await checkDealer('Bolton Kia', 'https://www.boltonkia.com/en/used-inventory');
  await checkDealer('North York Kia', 'https://www.northyorkkia.ca/en/used-inventory');
  await checkDealer('Kia of Newmarket', 'https://www.kiaofnewmarket.com/en/used-inventory');
  await checkDealer('Clarington Kia (Bowmanville)', 'https://www.claringtonkia.ca/en/used-inventory');

  // Honda dealer with Kia trade-ins
  await checkDealer('Whitby Oshawa Honda (Kia trade-ins)', 'https://www.whitbyoshawahonda.com/vehicles/kia/soul/');

  // Mazda dealers (trade-ins)
  await checkDealer('Scarborough Mazda', 'https://www.scarboroughmazda.com/en/used-inventory');
  await checkDealer('Markville Mazda', 'https://www.markvillemazda.com/en/used-inventory');
